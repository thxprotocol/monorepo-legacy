...
import { Withdrawal, WithdrawalState, WithdrawalType } from '@thxnetwork/wallet/store/modules/withdrawals';
...
import { TransactionState, TTransaction } from '@thxnetwork/wallet/types/Transactions';
