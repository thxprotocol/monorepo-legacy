  ...
  >
    <div class="flex-grow-1 overflow-auto d-flex flex-column">
      ...
      >
        ...
        <div class="mr-auto">
          <b-button to="/" variant="link">
            <img
              :src="require('@thxnetwork/wallet/../public/assets/img/logo.png')"
              height="32"
              alt=""
            />
          </b-button>
      ...
      >
        ...
        <router-view
          class="main-container flex-grow-1 overflow-auto shadow-lg py-3 p-3 mb-2"
        />
      </div>
      <footer
        v-if="$router.currentRoute.name"
...
export default class App extends Vue {
  ...
  created() {
    ...
    this.isDarkMode = !!JSON.parse(
      localStorage.getItem('thx:wallet:darkmode') || 'false'
    );
  }
