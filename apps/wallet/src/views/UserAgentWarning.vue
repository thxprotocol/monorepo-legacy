    ...
    <b-row>
      <b-col offset-md="2" md="8">
        ...
        <p>
          ...
          <strong class="text-primary"> {{ decodedHash.tokenSymbol }} </strong>,
          click <strong>Open in Chrome</strong> from the dropdown in the upper
          right corner.
        </p>
        <img
          width="100%"
          height="auto"
          :src="
            require('@thxnetwork/wallet/../public/assets/img/screenshot-android.png')
          "
        />
        <hr />
