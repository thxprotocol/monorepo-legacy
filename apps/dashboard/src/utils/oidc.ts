...
export const ADMIN_SCOPE =
    'openid account:read account:write rewards:read members:read members:write withdrawals:write swap:read swap:write erc20_rewards:read erc721_rewards:read referral_rewards:read shopify_rewards:read survey_rewards:read';
