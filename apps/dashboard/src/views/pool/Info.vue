<template>
  <div class="mb-5 pb-5">
    ...
    <p>
      Addresses and links to the block explorer pages regarding the smart
      contracts related to your pool.
    </p>
        ...
        <div class="input-group">
          ...
          <div class="input-group-append">
            <b-button
              ...
              :href="`${chainInfo[pool.chainId].blockExplorer}/address/${
                pool.address
              }/transactions`"
            >
              <i
                class="fas fa-external-link-alt m-0"
        ...
        <div class="input-group">
          ...
          <div class="input-group-append">
            <b-button
              ...
              :href="`${chainInfo[pool.chainId].blockExplorer}/token/${
                pool.erc20.address
              }`"
            >
              <i
