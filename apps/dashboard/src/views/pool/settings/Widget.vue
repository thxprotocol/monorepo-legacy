    ...
    <div>
        ...
        <b-form-row>
            <b-col md="4">
                ...
                <p class="text-muted">
                    This message is shown when the widget is loaded and should inform the user about the loyalty pool.
                </p>
            </b-col>
            <b-col md="8">
        ...
        <b-form-row>
            <b-col md="4">
                ...
                <p class="text-muted">Position the widget launcher on the left or right bottom side of the window.</p>
            </b-col>
            <b-col md="8">
                <b-form-group>
