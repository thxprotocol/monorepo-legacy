  ...
  <div class="container container-md pt-10" v-if="pool">
    <div class="d-flex justify-content-between align-items-center">
      <div class="d-flex align-items-center justify-content-between w-100">
        <h1 v-if="pool.erc20" class="mr-3">
          {{ fromWei(pool.erc20.poolBalance) }} {{ pool.erc20.symbol }}
        </h1>
        <h1 v-if="pool.erc721" class="mr-3">
      ...
      <div class="d-flex">
        <b-dropdown
          ...
          variant="link"
          dropleft
          class="d-flex ml-2 d-md-none"
        >
          <template #button-content>
            <i
              class="fas fa-ellipsis-v text-muted ml-0"
          ...
          >
            <i
              :class="route.iconClasses"
              class="ml-0 text-gray"
              style="width: 30px"
            ></i>
            {{ route.label }}
          </b-dropdown-item>
