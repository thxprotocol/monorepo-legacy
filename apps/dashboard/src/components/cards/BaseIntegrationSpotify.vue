    ...
    <b-card class="mb-3">
      <div class="mb-3 d-flex align-items-center">
        <img
          height="30"
          class="mr-3"
          :src="require('../../../public/assets/logo-spotify.png')"
          alt=""
        />
      ...
      <hr />
      <p class="text-muted">
        Connect and reward track and playlist save and follows.
      </p>
      <b-button
        v-if="!spotify"
        @click="connect()"
...
<script lang="ts">
import { IAccount, ISpotify } from '@thxprotocol/dashboard/types/account';
