<template>
    <b-card body-class="bg-light">
        <div class="d-flex align-items-center justify-content-between">
            <strong>Expiration & Limit</strong>
            <b-button variant="link" v-b-toggle.collapse-card-expiry>
                <i class="fas fa-chevron-down m-0"></i>
            </b-button>
        </div>
        <b-collapse id="collapse-card-expiry">
            <hr />
            <p class="text-gray">
                Configure until what date and time your customers are allowed to claim this reward. You can also provide
                a limit to determine the max amount of rewards available.
            </p>
            <b-form-group>
                <b-row>
                    <b-col md="6">
