...
import { API_URL } from '@thxprotocol/dashboard/utils/secrets';
import BaseModalErc721MetadataMint from '@thxprotocol/dashboard/components/modals/BaseModalERC721MetadataMint.vue';
