    ...
    <b-skeleton-wrapper :loading="isLoading">
        ...
        <b-card class="mb-3">
            <div class="mb-3 d-flex align-items-center">
                <img height="30" class="mr-3" :src="require('../../../public/assets/logo-twitter.png')" alt="" />
...
<script lang="ts">
import type { IAccount, ITwitter } from '@thxnetwork/dashboard/types/account';
...
export default class BaseIntegrationTwitter extends Vue {
    ...
    connect() {
        this.$store.dispatch('account/connectRedirect', RewardConditionPlatform.Twitter);
    }
