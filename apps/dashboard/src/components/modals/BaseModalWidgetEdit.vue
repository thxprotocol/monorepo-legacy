<template>
  ...
  >
    ...
    <div class="pt-5 pb-3" v-if="loading">
      <p class="text-center">
        <strong>We are assembling your widget</strong><br /><span
          class="text-muted"
        >
      ...
      <div class="row">
              ...
              <b-form-group>
                ...
                <b-form-select v-model="widgetEmoji">
                  <b-form-select-option
                    ...
                    :value="emoji"
                  >
                    <div class="d-block rounded-pill">
        ...
        <div class="col-md-6" v-if="widget.reward">
          <b-card bg-variant="light" class="border-0" body-class="p-3">
            ...
            <p class="small">
              Paste the embed code somewhere in your HTML page and make sure to
              use the correct Page URL so you don't run into those nasty CORS
              issues.
            </p>
