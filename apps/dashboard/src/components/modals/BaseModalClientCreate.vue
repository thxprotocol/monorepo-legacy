          ...
          <b-row class="mb-2">
            <b-col>
              ...
              <b-select :disabled="isEditing" v-model="grantType">
                <b-select-option value="authorization_code"
                  >Authorization Code</b-select-option
                >
                <b-select-option value="client_credentials"
                  >Client Credentials</b-select-option
                >
              </b-select>
            </b-col>
          </b-row>
...
export default class BaseModalClientCreate extends Vue {
  ...
  get isValid() {
    return this.grantType === 'authorization_code'
      ? this.redirectUri !== '' && this.requestUri !== ''
      : true;
  }
