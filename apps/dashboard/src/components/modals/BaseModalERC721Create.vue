    ...
    <template #modal-body v-if="!loading">
      ...
      <b-form-group>
        ...
        >
          ...
          <p>
            ERC-721 standard adhering to the default metadata specification.
          </p>
        </b-form-radio>
        <b-form-radio
          v-model="variant"
        ...
        >
          ...
          <p>
            ERC-721 standard adhering to the OpenSea metadata specification.
          </p>
        </b-form-radio>
      </b-form-group>
      <b-row>
      ...
      <b-form-group>
        ...
        <b-alert
          variant="warning"
          show
          v-if="variant === ERC721Variant.OpenSea"
        >
          <i class="fas fa-exclamation-triangle mr-2"></i>
          <strong
            >Support of Open Sea attributes is currently in active
            development.</strong
          >
          You will be able to add custom attributes after creating a collection,
          so feel free to go ahead with the defaults.
        </b-alert>
        <b-button
          block
          @click="
      ...
      case ERC721Variant.OpenSea:
        this.schema = [
          ...
          },
          {
            ...
            propType: 'link',
            description:
              'A link referencing to a page with more information on the item.',
            disabled: true,
          },
          {
            name: 'image',
