  ...
  >
    ...
    <b-form-group>
      ...
      <div
        ...
        :class="
          description.length >= titleMaxLength ? 'text-danger' : 'text-muted'
        "
      >
        {{ title.length }}/50
      </div>
    ...
    <b-form-group>
      ...
      <div
        class="text-right small"
        :class="
          description.length >= descMaxLength ? 'text-danger' : 'text-muted'
        "
      >
    ...
    >
    <b-form-group>
      Price: <b-form-input type="number" min="0" v-model="price" />
    </b-form-group>
