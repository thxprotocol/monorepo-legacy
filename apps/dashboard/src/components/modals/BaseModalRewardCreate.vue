                            ...
                            <b-row>
                                ...
                                <b-col md="6">
                                    ...
                                    <base-dropdown-channel-actions
                                        v-if="channel && channel.actions && channel.actions.length > 0"
                                        :actions="
...
import { channelActionList, ChannelType, ChannelAction, channelList } from '@thxnetwork/dashboard/types/rewards';

import type { IChannel, IChannelAction, Reward } from '@thxnetwork/dashboard/types/rewards';
import type { IAccount, ITwitter, IYoutube } from '@thxnetwork/dashboard/types/account';
...
export default class ModalRewardCreate extends Vue {
    ...
    async onActionClick(action: IChannelAction) {
        this.action = action;
        if (!this.item && this.channelActions[action.type].items) this.item = this.channelActions[action.type].items[0];
    }
