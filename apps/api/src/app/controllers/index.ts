...
import rewardsNftRouter from './rewards-nft/rewards-nft.router';
import rewardsReferralRouter from './rewards-referral/rewards-referral.router';
import rewardsTokenRouter from './rewards-token/rewards-token.router';
...
router.use('/rewards-nft', rewardsNftRouter);
router.use('/rewards-referral', rewardsReferralRouter);
router.use('/rewards-token', rewardsTokenRouter);
