...
describe('Referral Rewards', () => {
    let poolId: string, tokenAddress: string, milestoneRewardId: string, token: string;
    ...
    it('POST /referral-rewards', (done) => {
        ...
        user.post('/v1/referral-rewards/')
            ...
            .expect((res: request.Response) => {
                ...
                milestoneRewardId = res.body._id;
    ...
    it('POST /referral/:token/qualify', (done) => {
        user.post(`/v1/webhook/referral/${token}/qualify`)
            ...
            .expect((res: request.Response) => {
                expect(res.body.milestoneRewardId).toBe(milestoneRewardId);
                expect(res.body.uuid).toBeDefined();
...
describe('Milestone Rewards', () => {
    ...
    it('POST /milestones/:token/claim', (done) => {
        user.post(`/v1/webhook/milestone/${token}/claim`)
            .send({
