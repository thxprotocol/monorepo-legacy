import { JobType, QuestVariant, RewardConditionInteraction, RewardConditionPlatform } from '@thxnetwork/types/enums';
import { TAccount, TPointReward, TQuest, TQuestEntry } from '@thxnetwork/types/interfaces';
import { v4 } from 'uuid';
